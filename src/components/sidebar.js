    ...
    return (
        <motion.div className="sidebar"
            ...
            <figure className="sidebar__social_icons my-2">
                <a href="https://www.facebook.com/sumanssj4/" ><img src={facebook} alt="facebook" className="sidebar__icon mr-3" /></a>
                <a href="https://www.instagram.com/suman500bn/" ><img src={instagram} alt="instagram" className="sidebar__icon" /></a>
            </figure>
            <div className="sidebar__contact">
                <div className="sidebar__item sidebar__linkgit">
                    <a href="https://github.com/suman500bn"><img src={github} alt="github" className="sidebar__icon mr-3" /></a>
                    <a href="https://www.linkedin.com/in/skin/"><img src={linkedin} alt="linkedin" className="sidebar__icon" /></a>
                </div>
